...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void jumpToSetUpLayout(){
        ...
        this.inputServerIP = (EditText) findViewById(R.id.isIP);
    ...
    public void onClick(View v) {
        ...
        String resultString = Double.toString(num1) + oper + Double.toString(num2) + "=" + Double.toString(result);
        this.sendMessage(resultString);
        jumpToResultLayout(new String(num1 + " " + oper + " " + num2 + " = " + result));
    }
    private void sendMessage(String mg){
        this.writer.println(mg);
        this.writer.flush();
    }
